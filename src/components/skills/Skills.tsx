...
const Skills = () => {
    const skills = ["Project Management", "Analytics", "Collaboration & Communication", "Customer Feedback", "Design Collaboration", "Documentation & Knowledge", "Experimentation", "Frameworks & Methods", "Market Research", "PM Resources", "AI", "Prototyping", "Roadmapping Tools", "User Research"];
    return (
